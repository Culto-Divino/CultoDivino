    ...
    <div>
      ...
      <div class="flex w-full">
        <input
          id="serchArchetype"
          v-model="searchQuery"
          class="text-white bg-transparent outline-none px-2 border-b w-full"
        />
        <label for="serchArchetype" class="text-white"
      ...
      <div class="w-full h-full flex">
        <select
          ...
          @input="
            $emit(
              'update:selected',
              //@ts-expect-error, value sempre existirá.
              $event.target.value
            )
          "
        >
        ...
        <div>
          <label
            ...
            class="absolute right-0 mr-4 mt-5 text-black"
...
<script setup lang="ts">
  ...
  function filterElements() {
    ...
    props.elements.forEach((element: string) => {
      if (
