<template>
  <div v-if="!pending">
    <Header />
    <div
      class="w-screen h-screen bg-gradient-to-r from-bgColor1 to-bgColor2 flex justify-center items-center truncate text-white"
    >
      <div
        id="default-carousel"
      ...
      >
        ...
        <div class="flex w-5/12 justify-evenly mt-2">
          <input
            ...
            class="pl-2 bg-transparent bg-gradient-to-r from-cyan-900 to-sky-900 outline-none border-b rounded-full hover:rounded transition duration-2000 ease-in-out"
          />
...
let { pending, data: characters, error: error } = await useLazyAsyncData(
  "characters",
  () =>
