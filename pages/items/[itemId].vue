    ...
    <div class="w-screen h-screen bg-gradient-to-r from-bgColor1 to-bgColor2 overflow-y-scroll overflow-x-hidden z-0 flex flex-col justify-center items-center break-words">
        ...
        <div class="w-11/12 h-5/6 flex flex-col items-center mt-10 overflow-y-auto pc:items-start">
            ...
            <div class="w-full flex flex-col items-center justify-center pc:flex-row">
                ...
                <p class="mt-5 text-4xl pc:mt-0 pc:ml-10">Caixa de Som</p>
            </div>
            <div class="w-full flex cel:flex-col justify-evenly">
                <div class="w-full h-20 mt-5 flex items-center justify-evenly pc:flex-col pc:mt-5 pc:items-start h-full pc:w-3/12">
    
                    <div class="w-5/12 h-20 bg-black/50 flex flex-col rounded-md border border-sky-500 pc:w-full">
                        <p class="w-full h-2/5 pl-2">Peso:</p>
                        <p class="w-full h-full flex items-center justify-center text-2xl">2Kg</p>
                    </div>
                    
                    <div class="w-5/12 h-20 bg-black/50 flex flex-col rounded-md border border-sky-500 pc:mt-3 pc:w-full">
                        <p class="w-full h-2/5 pl-2">Espaço:</p>
                        <p class="w-full h-full flex items-center justify-center text-2xl">3</p>
                    </div>
    
                </div>
    
                <div class="w-full h-80 mt-5 flex flex-col items-center justify-center pc:w-8/12">
                    <h1 class="text-xl pc:hidden">Descrição</h1>
                    <textarea name="" class="w-full h-80 mt-5 bg-black/50 rounded-lg border border-sky-500 outline-none p-2 break-all" disabled> É o item mais foda de todos, ele toca som. </textarea>
                </div>
            </div>
        ...
        <label for="my-modal-5" class="modal cursor-pointer modal-center cel:modal-bottom">
