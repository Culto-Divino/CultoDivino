  ...
  <ClientOnly>
    ...
    >
      ...
      >
        ...
        />
        <div
          class="text-xl w-4/6 pc:ml-20 pc:min-h-[66%] pc:flex pc:flex-col pc:justify-center"
        >
          <div class="flex">
          ...
          <div class="flex mt-1">
            ...
            <p class="text-white pl-1">
              {{ character.archetype.parentClass.name }}
            </p>
          </div>
          <div class="flex mt-1">
            <p class="text-slate-300">Arquétipo:</p>
            <p class="text-white pl-1">{{ character.archetype.name }}</p>
          </div>
