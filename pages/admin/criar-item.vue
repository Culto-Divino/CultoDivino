    ...
    <div class="w-screen h-screen bg-gradient-to-r from-bgColor1 to-bgColor2 flex flex-col justify-center items-center truncate text-white">
        <div class="w-11/12 h-5/6 bg-gray-200/25 rounded-md overflow-y-scroll flex flex-col items-center">
            ...
            <div class="flex flex-col justify-center w-10/12 mt-2">
                ...
                <input id="itemName" type="text" class="bg-transparent bg-gray-400/75 outline-none text-black h-10 mt-1 px-2 rounded-md focus:bg-slate-300 focus:rounded">
            </div>
            <div class="flex flex-col -justify-center w-10/12 mt-7 mb-10 h-80">
                <label for="itemDesc">Descrição do item:</label>
                <textarea id="itemDesc" name="itemDesc" class="w-full h-80 bg-transparent bg-gray-400/75 outline-none text-black mt-1 p-2 rounded-md focus:bg-slate-300 focus:rounded"></textarea>
            </div>
            <div class="flex h-20 w-10/12 justify-between">
                <div class="flex flex-col justify-center h-16 w-5/12">
                    ...
                    <input id="itemWeight" type="text" class="bg-transparent bg-gray-400/75 outline-none text-black h-10 mt-1 px-2 rounded-md focus:bg-slate-300 focus:rounded">
                </div>
                <div class="flex flex-col justify-center h-16 w-5/12">
            ...
            <div class="flex w-10/12 mt-6 justify-between mb-6">
                <button class="h-10 w-5/12 bg-red-600 rounded" @click="cancelCreation()">Cancelar</button>
